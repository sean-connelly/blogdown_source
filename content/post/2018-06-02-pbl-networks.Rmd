...
```{r pdx gif,echo=T,fig.show='animate',ffmpeg.format='gif',dev='jpeg'}
...
#Portland
gganimate(plot_pdx,ani.width =  1000,ani.height = 800,title_frame = T)

```



```{r sfca gif,echo=T,fig.show='animate',ffmpeg.format='gif',dev='jpeg'}

#Set animation interval at 1/2 second
animation::ani.options(interval = .5)

#San Francisco
gganimate(plot_sfca,ani.width =  1000,ani.height = 800,title_frame = T)

```



```{r seattle gif,echo=T,fig.show='animate',ffmpeg.format='gif',dev='jpeg'}

#Set animation interval at 1/2 second
animation::ani.options(interval = .5)

#Seattle
gganimate(plot_seattle,ani.width =  1000,ani.height = 800,title_frame = T)

```



```{r dc gif,echo=T,fig.show='animate',ffmpeg.format='gif',dev='jpeg'}

#Set animation interval at 1/2 second
animation::ani.options(interval = .5)

#Washington DC
gganimate(plot_dc,ani.width =  1000,ani.height = 800,title_frame = T)
